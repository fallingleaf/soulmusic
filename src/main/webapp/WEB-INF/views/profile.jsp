		        ...
		        <div class="col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 main">
					...
					<div class="album-container">
						<c:forEach var="album" items="${albums}">
							<div class="album">
								<a href="<c:url value='/albums/${album.getId()}'/>">
									<img src="<c:url value='/resources/images/albumicon.jpeg' />" alt="album cover"/>
									<p><c:out value="${album.getName()}"/></p>
								</a>
							</div>
						</c:forEach>
					</div>
					...
					<div class="row">
						<div class="album-form col-md-4 col-sm-6">
							<h3>Add new Album</h3>
							<c:url var="addAlbum" value="/addAlbum"/>
							<form:form commandName="album" cssClass="form" action="${addAlbum}" method="post">
