    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
			        <div class="content">
			        	<h1><spring:message code="msg.signup"/></h1>
				        ...
				        <form:form commandName="user" cssClass="form" method="post" action="register">
				            ...
				            <div class="form-group">
				            	<label><spring:message code="msg.passwordRepeat"/></label>
				            	<form:password cssClass="form-control" path="password_repeat"/>
				            	<form:errors cssClass="error" path="password_repeat"/>
				            </div>
				            <input type="hidden" name="<c:out value="${_csrf.parameterName}"/>" value="<c:out value="${_csrf.token}"/>"/>
				            <input class="btn btn-primary" type="submit" value="<spring:message code="msg.register"/>" />
			        	</form:form>
			        </div>
			    </div>
			</div>
